...
// in simple_webdav_client/test/unit_test/std_test/param_test/delete_test.dart.
...
import 'package:simple_webdav_client/src/_std/if.dart' as _i6;
...
/// A class which mocks [IfOr].
///
/// See the documentation for Mockito's code generation for more information.
class MockIfOr extends _i1.Mock implements _i6.IfOr {
  MockIfOr() {
    _i1.throwOnMissingStub(this);
  }
}
