...
// in simple_webdav_client/test/unit_test/std_test/framework_test/client_test.dart.
...
class _FakeStreamTransformer_6<S, T> extends _i1.SmartFake
    implements _i4.StreamTransformer<S, T> {
  _FakeStreamTransformer_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeConverter_7<S, T> extends _i1.SmartFake
...
class _FakeSink_8<T> extends _i1.SmartFake implements Sink<T> {
  _FakeSink_8(
    Object parent,
    Invocation parentInvocation,
  ) : super(
  ...
  _i4.StreamTransformer<List<int>, String> putIfAbsent(
    ...
    _i4.StreamTransformer<List<int>, String> Function()? ifAbsent,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _FakeStreamTransformer_6<List<int>, String>(
          this,
          Invocation.method(
            #putIfAbsent,
            [
...
class MockResponseResultParser<
  ...
  _i3.Converter<_i10.ResponseResultParserParam, TT> fuse<TT>(
      ...
      (super.noSuchMethod(
        ...
        returnValue: _FakeConverter_7<_i10.ResponseResultParserParam, TT>(
          this,
          Invocation.method(
            #fuse,
            [other],
  ...
  Sink<_i10.ResponseResultParserParam> startChunkedConversion(Sink<O>? sink) =>
      (super.noSuchMethod(
        ...
        returnValue: _FakeSink_8<_i10.ResponseResultParserParam>(
          this,
          Invocation.method(
            #startChunkedConversion,
            [sink],
  ...
  _i3.Converter<RS, RT> cast<RS, RT>() => (super.noSuchMethod(
        ...
        returnValue: _FakeConverter_7<RS, RT>(
          this,
          Invocation.method(
            #cast,
            [],
